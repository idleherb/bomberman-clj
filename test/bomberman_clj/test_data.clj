...
(defn make-player-1 [] {:bomb-count 1, :bomb-radius 3, :glyph \@, :name "White Bomberman"})
(defn make-player-2 [] {:bomb-count 1, :bomb-radius 3, :glyph \&, :name "Pretty Bomber"})
(defn make-player-3 [] {:bomb-count 1, :bomb-radius 3, :glyph \^, :name "Black Bomberman"})
